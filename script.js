...
var _this = this;
var shopSection = document.querySelector('.shop');
...
var appendData = function (shopList) {
    shopList.forEach(function (shopObject) {
        var objectElement = document.createElement('div');
        objectElement.classList.add('card');
        objectElement.id = "card-id-".concat(shopObject.id);
        ...
        shopSection === null || shopSection === void 0 ? void 0 : shopSection.appendChild(objectElement);
    });
};
